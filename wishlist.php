...
<section class="movie-list container mb-5">
    ...
    <?php
      ...
      $id = $_SESSION["user"];
      $query = "SELECT f.id, f.judul, f.genre, f.tglRilis, f.ratingAge, f.hrgSewa, f.hrgBeli, f.img, f.poster, f.deskripsi, f.link, f.status FROM wishlist wh INNER JOIN film f ON wh.idFilm = f.id WHERE wh.idUser = $id";
